...
сходства Жаккара, метода, основанном на подсчете частот, расстояния Левенштейна или сходство Джаро-Винклера.
...
их растоянием на основе частотности.
...
Шаг 16. Определить совпадающие символы
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
считаться идеальными кандидатами друг для друга и совпадут во всех позициях,
тогда как при расстоянии 0 совпадающим будет один символ *к* (поиск строгого позиционного совпадения).


Шаг 19. Подсчитать количество транспозиций
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
Вновь обратимся к коту,
тогда ``count_transpositions('кот', 'кто', [True, True, True], [True, True, True])`` -> 1:
...
Шаг 20. Рассчитать расстояние Джаро
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
.. math::
   ...
   D_\text{Jaro}(s_1, s_2) = 1 - J(s_1, s_2)
...
Шаг 21. Реализовать поправку Винклера
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
Шаг 22. Рассчитать расстояние Джаро–Винклера
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
большее для эрратива *превед*, что соответствует принципу минимизации расстояния.

Добавьте подсчет расстояния Джаро–Винклера в функции
:py:func:`lab_2_spellcheck.main.calculate_distance` и
:py:func:`lab_2_spellcheck.main.find_correct_word`.
